...
export const BIOMES = Object.freeze({
  forgottenKeep: biome({
    ...
    wallModel: "wall",
    decalTexture: "/assets/sprites/keep-decals.webp",
  ...
  ossuary: biome({
    ...
    decalTexture: "/assets/sprites/ossuary-decals.webp",
  ...
  emberFoundry: biome({
    ...
    decalTexture: "/assets/sprites/foundry-decals.webp",
  ...
  voidCourt: biome({
    ...
    decalTexture: "/assets/sprites/void-court-decals.webp",
